...
const Navbar = () => {
    ...
    return (
        <>
            <section className='my-3 flex items-center h-[50px] justify-between relative'>
                <div className='flex items-center h-[100%]'>
                    <div className='flex w-[70px] justify-center'>
                        <img onClick={() => router.push('/')} src='/logo.png' className='cursor-pointer aspect-square w-[70%] mr-[1rem]' />
                    </div>
                    <div className='flex gap-3 w-[50%] h-[100%] items-center'>
                        ...
                        <div className='flex h-[100%] items-center w-[600px] bg-[#2c2c2c] rounded-3xl gap-1 px-3'>
                ...
                {(userData.user && userData.user.statusSignUp === 3) ? (
                    <div className='flex items-center h-[100%] w-[50%] justify-end gap-4'>
                        ...
                        <img className='w-[50px] cursor-pointer rounded-full aspect-square' src='https://img.lovepik.com/element/45006/1283.png_860.png' />
                    </div>
                ) : (
            ...
            {/*Menu vertical*/}
            {(userData.user && userData.user.statusSignUp === 3) && (
                <section className='fixed h-[86%] w-[70px] left-2 flex flex-col items-center py-3 top-[70px]'>
